...
interface SearchAndFilterProps {
  ...
  onFilterClick: () => void;
  onAdvancedFilter?: (filters: AdvancedFilterOptions) => void;
}
      ...
      {showAdvancedFilter && (
        <div className="mt-4 pt-4 border-t border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setAdvancedFilters(prev => ({ ...prev, period: e.target.value }))}
            ...
            <div>
              ...
              <select
                value={advancedFilters.authorType || ""}
                onChange={(e) => setAdvancedFilters(prev => ({ ...prev, authorType: e.target.value }))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
                <option value="">전체</option>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setAdvancedFilters(prev => ({ ...prev, minLikes: e.target.value }))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
          ...
          <div className="flex justify-end gap-2 mt-4">
            ...
            <button
              type="button"
              onClick={() => onAdvancedFilter && onAdvancedFilter(advancedFilters)}
