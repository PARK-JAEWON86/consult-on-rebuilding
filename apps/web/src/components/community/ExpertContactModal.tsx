...
interface ExpertContactModalProps {
  isOpen: boolean;
  onClose: () => void;
  consultationPost?: ConsultationPost | null;
...
const ExpertContactModal = ({
  ...
  // 현재 전문가 정보 (실제로는 user에서 가져와야 함)
  const currentExpert = {
    id: user?.id || "1",
    name: user?.name || "전문가",
    avatar: user?.name?.charAt(0).toUpperCase() || "전",
    title: "상담 전문가", // user?.expert?.specialty || "상담 전문가",
    experience: "5년",
    rating: 4.8,
    reviewCount: 127,
            ...
            <div className="p-6 border-b border-gray-200 bg-gray-50">
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500">
                  ...
                  <span>작성자: {consultationPost.author.name}</span>
                </div>
              </div>
            </div>
