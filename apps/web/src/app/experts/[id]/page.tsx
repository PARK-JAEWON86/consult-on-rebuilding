...
export default function ExpertDetailPage() {
  ...
  // Debug logging
  console.log('🔍 Expert page debug:', { displayId, isLoading, expert, error });
              ...
              <div className="flex items-center justify-between h-16">
                <div className="flex items-center">
                  <button
                    ...
                    className="mr-4 p-2 hover:bg-white hover:shadow-sm rounded-full transition-all duration-200"
                  >
  ...
  // 백엔드에서 계산된 레벨 정보 사용 (fallback으로 프론트엔드 계산)
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-8">
        <div className="relative flex gap-8">
          ...
          <div className="hidden lg:block w-80 space-y-6">
            {/* 상담 예약 카드 */}
            <Card>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">상담 예약</h3>
              <div className="space-y-4">
