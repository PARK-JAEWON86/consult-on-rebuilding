      ...
      <div className="max-w-6xl mx-auto">
          ...
          <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200">
            <div className="p-6">
              ...
              <div className="text-sm text-blue-800 space-y-2">
                ...
                <p>
                  <strong>평균 요금:</strong> 분당 약 {averageRate} 크레딧 (₩{averageRate.toLocaleString()})
                </p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {/* 직접 충전 */}
            <Card>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">직접 충전</h3>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {presetAmounts.map((presetAmount) => (
                      <button
                        ...
                        className="p-3 rounded-xl border border-gray-300 hover:border-blue-500 hover:bg-blue-50 text-center transition-colors"
                      >
